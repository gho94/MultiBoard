	...
	<div class="pg-opt">
        <div class="row">
            <div class="col-md-6 pc">
                <h2><fmt:message key="UPDATE_USER_INFO"/>
                	<small style="color:red"><fmt:message key="${message}"/></small>
                </h2>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb">
		...
		<form action="<c:url value='/member/update'/>" method="post" id="joinForm" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input 
						...
						title="<fmt:message key='USERID_TITLE'/>" 
						pattern="\w+" 
						class="form-control" 
			...
			<div class="form-group">
				<label 
					...
					for="name"><fmt:message key="MEMBER_NAME"/>
				</label>
				<div class="col-sm-4">
					<input 
						type="text" 
			...
			<div class="form-group">
				<label 
					class="control-label col-sm-2" 
					for="phone"><fmt:message key="MEMBER_PHONE"/>
				</label>
				<div class="col-sm-4">
					<input 
						type="text" 
			...
			<div class="form-group">
				<label 
					class="control-label col-sm-2" 
					for="email"><fmt:message key="MEMBER_EMAIL"/>
				</label>
				<div class="col-sm-4">
					<input 
						type="email" 
...
<script type="text/javascript">
	...
	var pwConfirm = document.querySelector("#password2Confirm);
