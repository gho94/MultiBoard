		...
		<div class="pg-opt">
			<div class="row">
				<div class="col-md-6 pc">
					<h2><fmt:message key="CONTENT"></fmt:message></h2>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
						<li><fmt:message key="BOARD"></fmt:message></li>
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						...
						<c:if test="${(filetype eq '.JPG') or (filetype eq 'JPEG') or (filetype eq '.PNG') or (filetype eq '.GIF')}"><img alt="" src='<c:url value="/file/${board.fileId}"/>' class="img-thumbnail"><br></c:if>
